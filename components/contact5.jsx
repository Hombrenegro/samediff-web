...
const Contact = () => {
  ...
  return (
    ...
    <div className="absolute sm:translate-y-[-600px] md:translate-y-[-620px] lg:translate-y-[-720px] xl:translate-y-[-800px] 2xl:translate-y-[-820px] flex justify-center items-center z-0">
      <motion.div
        className="space-y-6 py-24 px-32 sm:text-lg md:text-lg lg:text-xl xl:text-2xl 3xl:text-3xl font-space-mono text-center text-white tracking-tight"
      ...
      >
        ...
        <motion.div
          className={`translate-y-[421px] xl:translate-y-200 absolute flex flex-col lg:flex-row justify-center items-center transition-opacity duration-300 ${isImageHovered ? 'opacity-100' : 'opacity-100'}`} // Adjusted for stacking at medium and below breakpoints
