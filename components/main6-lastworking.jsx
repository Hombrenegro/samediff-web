...
const style = {
  ...
  videoLogoContainer: `flex-grow-0 | flex | items-center | justify-center | w-full h-screen | -mt-24 | pb-24 | pt-1 | mt-0 | z-1`,
  typewriterContainer: ` flex-grow-0 | flex | items-center | justify-center | w-full h-screen,`
};
  ...
  return (
    <div className={style.mainComp}>
      ...
      <div className={`${style.typewriterContainer}`}>
          <h1 style={{"font-size": "2.5vw"}} className="font-space-grotesk | font-normal | text-sd-gray | relative | z-10">
          <Type />
        </h1>
      </div>
