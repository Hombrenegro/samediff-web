...
const Main = () => {
  return (
    <div className={style.mainComp}>
      ...
      {/* Typewriter */}
      <div className="py-16 sm:py-6 xs:py-6 text-center -translate-y-[120px] min-h-[60px] min-w-[300px]">
        <h1 className="pointer-events-none items-center font-space-mono xl:text-[40px] lg:text-[30px] md:text-[20px] sm:text-[15px] tracking-[.01em] text-sd-gray">
          <Type />
        </h1>
      </div>
